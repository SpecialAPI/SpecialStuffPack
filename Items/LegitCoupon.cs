...
namespace SpecialStuffPack.Items
{
    public class LegitCoupon : PassiveItem
    {
        public static void Init()
        {
            ...
            LegitCoupon item = ItemBuilder.EasyInit<LegitCoupon>("items/legitcoupon", "sprites/legit_coupon_idle_001", name, shortdesc, longdesc, ItemQuality.D, SpecialStuffModule.globalPrefix, null, null);
