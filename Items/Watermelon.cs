...
namespace SpecialStuffPack.Items
{
    public class Watermelon : PlayerItem
    {
        public static void Init()
        {
            ...
            Watermelon item = ItemBuilder.EasyInit<Watermelon>("items/watermelon", "sprites/watermelon_idle_001", name, shortdesc, longdesc, ItemQuality.B, SpecialStuffModule.globalPrefix, null, null);
