...
namespace SpecialStuffPack.Items
{
    public class GravediggerShovel : PlayerItem
    {
        public static void Init()
        {
            ...
            GravediggerShovel item = ItemBuilder.EasyInit<GravediggerShovel>("items/gravediggershovel", "sprites/gravedigger_shovel_idle_001", name, shortdesc, longdesc, ItemQuality.C, SpecialStuffModule.globalPrefix, null, null);
