...
namespace SpecialStuffPack.Items
{
    public class OrbOfKnowledge : PlayerItem
    {
        public static void Init()
        {
            ...
            OrbOfKnowledge item = ItemBuilder.EasyInit<OrbOfKnowledge>("items/8ball", "sprites/8_ball_idle_001", name, shortdesc, longdesc, ItemQuality.D, null, null);
            item.SetCooldownType(ItemBuilder.CooldownType.Timed, 1.5f);
