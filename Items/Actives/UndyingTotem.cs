...
namespace SpecialStuffPack.Items
{
    public class UndyingTotem : PlayerItem
    {
        public static void Init()
        {
            ...
            UndyingTotem item = ItemBuilder.EasyInit<UndyingTotem>("items/totem", "sprites/totem_idle_001", name, shortdesc, longdesc, ItemQuality.B, SpecialStuffModule.globalPrefix, null, null);
