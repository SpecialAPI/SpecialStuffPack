...
namespace SpecialStuffPack.Items
{
    public class OtherworldlyAssistance : UniqueOutlineItem
    {
        public static void Init()
        {
            ...
            OtherworldlyAssistance item = ItemBuilder.EasyInit<OtherworldlyAssistance>("items/keytobeyond", "sprites/key_to_beyond_idle_001", name, shortdesc, longdesc, ItemQuality.A, null, null);
