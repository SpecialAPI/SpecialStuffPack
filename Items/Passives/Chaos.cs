...
namespace SpecialStuffPack.Items.Passives
{
    public class Chaos : PassiveItem
    {
        public static void Init()
        {
            ...
            ItemBuilder.EasyInit<Chaos>("items/chaos", "sprites/chaos_idle_001", name, shortdesc, longdesc, ItemQuality.S, SpecialStuffModule.globalPrefix, null, null).AddToGooptonShop();
        }
