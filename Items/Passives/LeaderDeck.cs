...
namespace SpecialStuffPack.Items.Passives
{
    public class LeaderDeck : PassiveItem
    {
        public static void Init()
        {
            ...
            var item = EasyItemInit<LeaderDeck>("leaderdeck", "leader_deck_idle_001", name, shortdesc, longdesc, ItemQuality.A, null, null);
            RoomFactory.AddInjection(RoomFactory.BuildFromTextAsset("leaderdeck_twocards").room, "Leader's Deck Two Cards", new List<ProceduralFlowModifierData.FlowModifierPlacementType> {
        ...
        public override void Pickup(PlayerController player)
        {
            ...
            {
                LootEngine.SpawnItem(TarotCards.GetTarotCardForPlayer(player).gameObject, player.specRigidbody.UnitBottomCenter, Vector2.down, 0f, true, false, false);
            }
