...
namespace SpecialStuffPack.Items.Passives
{
    public class BloodyScales : PassiveItem
    {
        ...
        public static void Init()
        {
            ...
            var item = ItemBuilder.EasyInit<BloodyScales>("items/bloodyscales", "sprites/bloody_scales_idle_001", name, shortdesc, description, ItemQuality.A, SpecialStuffModule.globalPrefix, null, null);
