...
namespace SpecialStuffPack.Items
{
    public class Calendar
    {
        public static void Init()
        {
            ...
            PassiveItem item = ItemBuilder.EasyInit<PassiveItem>("items/calendar", "sprites/calendar_idle_001", name, shortdesc, longdesc, PickupObject.ItemQuality.B, 524, null);
