...
namespace SpecialStuffPack.Items.Passives
{
    public class BalancingPole : PassiveItem
    {
        ...
        public static void Init()
        {
            ...
            ItemBuilder.EasyInit<BalancingPole>("items/balancingpole", "sprites/balancing_pole_idle_001", name, shortdesc, longdesc, ItemQuality.B, SpecialStuffModule.globalPrefix, null, null);
