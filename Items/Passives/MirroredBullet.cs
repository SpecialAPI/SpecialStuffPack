...
namespace SpecialStuffPack.Items.Passives
{
    public class MirroredBullet : PassiveItem
    {
        public static void Init()
        {
            ...
            MirroredBullet item = ItemBuilder.EasyInit<MirroredBullet>("items/mirrorbullet", "sprites/mirrored_bullet_idle_001", name, shortdesc, longdesc, ItemQuality.S, null, null);
