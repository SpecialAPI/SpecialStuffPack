...
namespace SpecialStuffPack.Items.Passives
{
    public class HeartPiece
    {
        public static void Init()
        {
            ...
            var obtainable = EasyItemInit<PassiveItem>("HeartPiece", "heart_piece_idle_001", name, shortdesc, longdesc, PickupObject.ItemQuality.D, null, null);
            obtainable.AddPassiveStatModifier(PlayerStats.StatType.Health, 0.5f);
            var unobtainable = EasyItemInit<PassiveItem>("UnobtainableHeartPiece", "heart_piece_idle_001", name, shortdesc, longdesc, PickupObject.ItemQuality.EXCLUDED, null, $"{SpecialStuffModule.globalPrefix}:unobtainable_heart_piece");
