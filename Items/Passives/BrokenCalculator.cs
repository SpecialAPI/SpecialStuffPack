...
namespace SpecialStuffPack.Items
{
    public class BrokenCalculator : PassiveItem
    {
        public static void Init()
        {
            ...
            BrokenCalculator item = ItemBuilder.EasyInit<BrokenCalculator>("items/brokencalculator", "sprites/broken_calculator_idle_001", name, shortdesc, longdesc, ItemQuality.D, SpecialStuffModule.globalPrefix, null, null);
