...
namespace SpecialStuffPack.Items
{
    public class AsteroidBelt : PassiveItem
    {
        public static void Init()
        {
            ...
            AsteroidBelt item = ItemBuilder.EasyInit<AsteroidBelt>("items/asteroidbelt", "sprites/asteroid_belt_idle_001", name, shortdesc, longdesc, ItemQuality.S, SpecialStuffModule.globalPrefix, 662, null);
