...
namespace SpecialStuffPack.Items
{
    public class SubscribeButton : PassiveItem
    {
        public static void Init()
        {
            ...
            SubscribeButton item = EasyInitItem<SubscribeButton>("items/subscribebutton", "sprites/subscribe_button_idle_001.png", name, shortdesc, longdesc, ItemQuality.S, 524, null);
