...
namespace SpecialStuffPack.Items
{
    public class SubscribeButton : PassiveItem
    {
        public static void Init()
        {
            ...
            SubscribeButton item = ItemBuilder.EasyInit<SubscribeButton>("items/subscribebutton", "sprites/subscribe_button_idle_001.png", name, shortdesc, longdesc, ItemQuality.S, 524, null);
