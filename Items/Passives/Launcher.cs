...
namespace SpecialStuffPack.Items.Passives
{
    public class Launcher : PassiveItem
    {
        public static void Init()
        {
            ...
            var launcher = ItemBuilder.EasyInit<Launcher>("items/launcher", "sprites/jumppad_idle_001", name, shortdesc, longdesc, ItemQuality.C, SpecialStuffModule.globalPrefix, null, null);
