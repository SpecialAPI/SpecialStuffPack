    ...
    public class OrbOfKnowledge : PlayerItem
    {
        public static void Init()
        {
            ...
            item.knowledge = new List<string>
            {
                ...
                "DID YOU KNOW, THERE IS AN ITEM IN THE MOD PACK THE BLEAKER ITEM PACK MADE BY POPULAR ENTER THE GUNGEON MODDER BLEAKBUBBLES (BLEAKBULLETS) FOR THE POPULAR ROGUE-LIKE VIDEO GAME ENTER THE GUNGEON CALLED HEALTHY BULLETS WHICH MAKES SOME " +
