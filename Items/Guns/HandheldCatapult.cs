...
{
    public class HandheldCatapult : AdvancedGunBehaviour
    {
        public static void Init()
        {
            ...
            Gun gun = GunBuilder.EasyGunInit("guns/catapult", name, shortdesc, longdesc, "catapult_idle_001", "gunsprites/ammonomicon/catapult_idle_001", "gunsprites/handheldcatapult", 100, 1f, new Vector2(0f, 0.6875f), null, "Baseball",
                PickupObject.ItemQuality.C, GunClass.CHARGE, SpecialStuffModule.globalPrefix, out var finish, null, null, null);
            ...
            finish();
            SynergyBuilder.AddDualWieldSynergyProcessor(gun, CodeShortcuts.GetItemById<Gun>(382), "Stone x2");
        }
