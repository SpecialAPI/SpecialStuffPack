...
namespace SpecialStuffPack.ChallengeAPI
{
    /// <summary>
    ...
    public static class ChallengeBuilder
    {
        ...
        public static void Init()
        {
            ...
            languageTextLoadHook = new Hook(
                ...
                typeof(ChallengeBuilder).GetMethod("LanguageTextLoadHook", BindingFlags.Public | BindingFlags.Static)
            );
            dfManagerStartHook = new Hook(
                typeof(dfGUIManager).GetMethod("Start", BindingFlags.Public | BindingFlags.Instance),
                typeof(ChallengeBuilder).GetMethod("DFManagerStartHook", BindingFlags.Public | BindingFlags.Static)
            );
